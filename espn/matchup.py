...
class Matchup:
    ...
    def __init__(self, matchup_data: Dict[str, Any], league: "League") -> None:
        self._data = matchup_data
        self._league = league
        self.matchup_num = self._data["matchupPeriodId"]
        self.scoring_periods = league.matchup_num_to_scoring_periods(self.matchup_num)
        self._boxscore_data = {
    ...
    def __repr__(self):
        ...
        home_exp = "{} ({})".format(self.home_team.full_name, self.home_score)
        if self.is_bye:
